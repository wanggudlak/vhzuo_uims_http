...
type UserInfoCursor struct {
	ID                    int        `gorm:"column:id;type:int(11) unsigned auto_increment;primary_key;comment:'主键ID'" json:"id"`
	UserInfoID            int        `gorm:"column:user_info_id;type:bigint(11) unsigned;not null;comment:'用户信息ID'" json:"user_info_id"`
	...
	NameFullPy            string     `gorm:"column:name_full_py;type:varchar(255);not null;default:'';comment:'用户姓名全拼音，英文空格分隔'" json:"name_full_py"`
	IdentityCardNo        string     `gorm:"column:identity_card_no;type:varchar(20);not null;default:'';comment:'用户的微信号'" json:"identity_card_no"`
...
func (UserInfoCursor) TableName() string {
	return "uims_user_info_cursor"
}
